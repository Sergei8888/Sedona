...
//Модальное окно
let modalFrame = document.getElementById('ask-question')
let openModalBtn = document.getElementById('openModalBtn')
let closeModalBtn = document.getElementById('closeModalBtn')

openModalBtn.addEventListener('click', () => {
    modalFrame.classList.toggle('modal--open')
})
...
//Фикс поведения лейбл элементов в модальном окне. При решении на css если в инпут что то есть, а фокус потерян, то лейбл инпута и введённый текст наслаиваются.
let modalInputs = document.querySelectorAll('.ask-question__input')
...
modalInputs.forEach(elem => {
    elem.addEventListener('focus', () => {
        if (elem.value) {
            ...
            elem.classList.toggle('ask-question__input--focused')
        }
    })
